...
import static waferroll.TokenType.*;
...
/*
interpreter grammer rule EBNF represantation:
...
public class Parser {
    ...
    private Stmt.Function function(String kind){
        ...
        consume(RIGHT_PAREN, "Except ')' after parameters.");

        consume(LEFT_BRACE, "Except '{' before " + kind + " body.");
    ...
    private Stmt continueStatement(){
        Token keyword = previous();
        consume(SEMICOLON, "Except ';' after continue");
